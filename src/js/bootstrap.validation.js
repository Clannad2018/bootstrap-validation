/* ========================================================= 
 * 
 * wj王健  <w.jian@ctrip.com>
 *
 * version 1.0.0.0 (2015/12/06)
 *
 * =========================================================
 *
...
!function () {
  ...
  BootstrapValidation.LOCALES['en-US'] = {
    requiredMessageFormatter: function () { return 'This is required!'; },
    integerMessageFormatter: function () { return 'Integer only!'; },
    numberMessageFormatter: function () { return 'Number only!'; },
    ipMessageFormatter: function () { return 'Invalid IP address!'; },
    emailMessageFormatter: function () { return 'Invalid email address!'; },
    charMessageFormatter: function () { return 'Character only!'; },
    urlMessageFormatter: function () { return 'Invalid URL address!'; },
    dateMessageFormatter: function () { return "Invalid data format (yyyy-MM-dd)!"; }
  }

  BootstrapValidation.LOCALES['zh-CN'] = {
    requiredMessageFormatter: function () { return '这是必填项！'; },
    integerMessageFormatter: function () { return '请输入整数！'; },
    numberMessageFormatter: function () { return '请输入数字！'; },
    ipMessageFormatter: function () { return '请输入正确的 IP 地址！'; },
    emailMessageFormatter: function () { return '请输入正确的邮箱地址！'; },
    charMessageFormatter: function () { return '请输入字符！'; },
    urlMessageFormatter: function () { return '请输入正确的网址！'; },
    dateMessageFormatter: function () { return "格式错误 yyyy-MM-dd！"; }
  }
  ...
  BootstrapValidation.DEFAULTS = {
    ...
    rules: {
      ...
      'ip': function (value) {
        return ($.trim(value) == '' || /^(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[1-9][0-9]|[1-9])(\.(25[0-5]|2[0-4][0-9]|1?[0-9]{1,2})){3}$/.test(value)) ? '' : BootstrapValidation.DEFAULTS['ipMessageFormatter']();
      },
  ...
  $(function () {
    $('[data-toggle="validation"]').bootstrapValidation();
  });
} (jQuery);
